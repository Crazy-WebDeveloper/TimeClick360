...
exports.username_verify = async (name) => {
    var data = null;
    var user =  await this.BfindOne(USERMODEL,{ name : name });
    if(!user){
        data = false;            
    }else{
        data = true
...
exports.password_verify = async (email,password) => {
    var data = null;
    var user = await this.BfindOne(USERMODEL,{email : email, password : password });
    if(!user){
        data = false;
    }else{
        data = user;
